...
-- Shared rate-limit buckets for horizontally scaled API instances.
-- Used by bimex-indexer/rateLimiter.js through consume_rate_limit_bucket().
...
-- Optional cleanup helper for old fixed-window buckets, stale SSE slots, and review logs.
